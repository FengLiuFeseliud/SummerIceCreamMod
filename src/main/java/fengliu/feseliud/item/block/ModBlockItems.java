...
public class ModBlockItems {
    ...
    public static final BaseBlockItem ICE_CRUSHER = RegisterUtil.registerItem(new BaseBlockItem("/close", ModBlocks.ICE_CRUSHER_BLOCK, 64), ModItemGroups.ITEM_GROUP);
