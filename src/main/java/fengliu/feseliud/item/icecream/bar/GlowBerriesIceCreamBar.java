...
public class GlowBerriesIceCreamBar extends IceCreamBar {
    public GlowBerriesIceCreamBar(Item.Settings settings, String name) {
        super(settings, name);
    }

    @Override
    public Map<IceCreamBar, IIceCreamLevel> getIceCreams() {
        return ModItems.GLOW_BERRIES_ICE_CREAM_BARS;
    }
