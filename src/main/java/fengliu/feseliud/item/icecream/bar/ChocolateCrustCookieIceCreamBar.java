...
public class ChocolateCrustCookieIceCreamBar extends IceCreamBar {
    public ChocolateCrustCookieIceCreamBar(Item.Settings settings, String name) {
        super(settings, name);
    }
    ...
    public enum IceCreamLevels implements IIceCreamLevel {
        ...
        public BaseItem getItem() {
            return new ChocolateCrustCookieIceCreamBar(new FabricItemSettings().maxCount(1).maxDamage(this.getMaxLevel()).food(this.getFoodComponent()), this.getName());
        }
    }
}