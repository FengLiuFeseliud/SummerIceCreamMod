...
public class ChocolateChorusFruitIceCreamCup extends ChorusFruitIceCreamCup{
    public ChocolateChorusFruitIceCreamCup(Settings settings, String name, boolean spoon) {
        super(settings, name, spoon);
    }

    @Override
    public Map<IceCreamBar, IIceCreamLevel> getIceCreamAndSpoons() {
        return ModItems.CHOCOLATE_CHORUS_FRUIT_ICE_CREAM_CPUS_AND_SPOON;
    }

    @Override
    public Map<IceCreamBar, IIceCreamLevel> getIces() {
        return ModItems.CHOCOLATE_CHORUS_FRUIT_ICE_CREAM_CPUS;
    }
