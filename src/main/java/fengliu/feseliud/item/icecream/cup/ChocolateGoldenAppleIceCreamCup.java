...
public class ChocolateGoldenAppleIceCreamCup extends IceCreamCup{
    public ChocolateGoldenAppleIceCreamCup(Settings settings, String name, boolean spoon) {
        super(settings, name, spoon);
    }

    @Override
    public Map<IceCreamBar, IIceCreamLevel> getIceCreamAndSpoons() {
        return ModItems.CHOCOLATE_GOLDEN_APPLE_ICE_CREAM_CUPS_AND_SPOON;
    }

    @Override
    public Map<IceCreamBar, IIceCreamLevel> getIces() {
        return ModItems.CHOCOLATE_GOLDEN_APPLE_ICE_CREAM_CUPS;
    }
    ...
    public enum IceCreamLevels implements IIceCreamLevel {
        ...
        THAW_ALMOST_ALL(4, 150, 2, "thaw_almost_all"),
    ...
    public enum IceCreamAndSpoonLevels implements IIceCreamLevel {
        ...
        SPOON_THAW_ALMOST_ALL(4, 150, 2, "spoon_thaw_almost_all"),
