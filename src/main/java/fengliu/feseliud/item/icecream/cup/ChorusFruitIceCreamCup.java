...
public class ChorusFruitIceCreamCup extends IceCreamCup{
    public ChorusFruitIceCreamCup(Settings settings, String name, boolean spoon) {
    ...
    public Map<IceCreamBar, IIceCreamLevel> getIceCreamAndSpoons() {
        return ModItems.CHORUS_FRUIT_ICE_CREAM_CPUS_AND_SPOON;
    }

    @Override
    public Map<IceCreamBar, IIceCreamLevel> getIces() {
        return ModItems.CHORUS_FRUIT_ICE_CREAM_CPUS;
    }
