...
public class ChocolateBaseChocolateCreamCup extends IceCreamCup{
    public ChocolateBaseChocolateCreamCup(Settings settings, String name, boolean spoon) {
        super(settings, name, spoon);
    }

    @Override
    public Map<IceCreamBar, IIceCreamLevel> getIces() {
        return ModItems.CHOCOLATE_BASE_CHOCOLATE_ICE_CREAM_CUPS;
    }

    @Override
    public Map<IceCreamBar, IIceCreamLevel> getIceCreamAndSpoons() {
        return ModItems.CHOCOLATE_BASE_CHOCOLATE_ICE_CREAM_BARS_AND_SPOON;
    }
    ...
    public enum IceCreamLevels implements IIceCreamLevel {
        ...
        public String getName() {
            return "chocolate_base_chocolate_ice_cream_cup";
        }

        @Override
        public BaseItem getItem() {
            return new ChocolateBaseChocolateCreamCup(new FabricItemSettings().maxCount(1).maxDamage(this.getMaxLevel()).food(this.getFoodComponent()), this.getName(), false);
        }
    ...
    public enum IceCreamAndSpoonLevels implements IIceCreamLevel {
        ...
        @Override
        public BaseItem getItem() {
            return new ChocolateBaseChocolateCreamCup(new FabricItemSettings().maxCount(1).maxDamage(this.getMaxLevel()).food(this.getFoodComponent()), this.getName(), true);
        }
