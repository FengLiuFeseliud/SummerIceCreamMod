...
public class BaseChocolateCreamCup extends IceCreamCup {
    public BaseChocolateCreamCup(Settings settings, String name, boolean spoon) {
    ...
    public enum IceCreamLevels implements IIceCreamLevel {
        ...
        public String getName() {
            return "base_chocolate_ice_cream_cup";
        }

        @Override
        public BaseItem getItem() {
            return new BaseChocolateCreamCup(new FabricItemSettings().maxCount(1).maxDamage(this.getMaxLevel()).food(this.getFoodComponent()), this.getName(), false);
        }
    ...
    public enum IceCreamAndSpoonLevels implements IIceCreamLevel {
        ...
        @Override
        public BaseItem getItem() {
            return new BaseChocolateCreamCup(new FabricItemSettings().maxCount(1).maxDamage(this.getMaxLevel()).food(this.getFoodComponent()), this.getName(), true);
        }
