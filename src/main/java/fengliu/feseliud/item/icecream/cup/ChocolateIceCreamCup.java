...
public class ChocolateIceCreamCup extends IceCreamCup{
    ...
    public enum IceCreamLevels implements IIceCreamLevel {
        ...
        public BaseItem getItem() {
            return new ChocolateIceCreamCup(new FabricItemSettings().maxCount(1).maxDamage(this.getMaxLevel()).food(this.getFoodComponent()), this.getName(), false);
        }
    ...
    public enum IceCreamAndSpoonLevels implements IIceCreamLevel {
        ...
        @Override
        public BaseItem getItem() {
            return new ChocolateIceCreamCup(new FabricItemSettings().maxCount(1).maxDamage(this.getMaxLevel()).food(this.getFoodComponent()), this.getName(), true);
        }
