...
public class ModItems {
    ...
    public static final IceCreamLiquidBucket CHOCOLATE_ICE_CREAM_LIQUID_BUCKET = register(new IceCreamLiquidBucket("chocolate_ice_cream_liquid_bucket", ModFluids.CHOCOLATE_ICE_CREAM_LIQUID_FLUIDS, FoodComponents.POTATO), ModItemGroups.MATERIALS_GROUP);
