...
public class ChocolateIceCreamBlock extends IceCreamBlock{
    public ChocolateIceCreamBlock(Settings settings, String name, IIceCreamBlockLevel iIceCreamBlockLevel) {
    ...
    public BlockEntityType<?> getBlockEntityType() {
        return ModBlockEntitys.CHOCOLATE_ICE_CREAM_BLOCK_ENTITYS.get(this.getIceCreamBlockLevel());
    }
