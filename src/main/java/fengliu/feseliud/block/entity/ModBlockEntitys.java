...
public class ModBlockEntitys {
    ...
    public static final BlockEntityType<IceCreamMachineBlockEntity> ICE_CREAM_MACHINE_BLOCK_ENTITY = RegisterUtil.registerBlockEntity(ModBlocks.ICE_CREAM_MACHINE_BLOCK, IceCreamMachineBlockEntity::new);
    public static final BlockEntityType<IceCrusherBlockEntity> ICE_CRUSHER_BLOCK_ENTITY = RegisterUtil.registerBlockEntity(ModBlocks.ICE_CRUSHER_BLOCK, IceCrusherBlockEntity::new);
